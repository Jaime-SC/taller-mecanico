...
class _AgregarEditarClienteDialogState
  ...
  void _guardarCliente() {
    ...
    if (rut.isEmpty || nombre.isEmpty || apellido.isEmpty || direccion.isEmpty || telefono.isEmpty || email.isEmpty) {
      // Muestra un diálogo o una notificación indicando que se deben llenar todos los campos.
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text("Campos Incompletos"),
            content: Text("Por favor, completa todos los campos para proceder."),
            actions: [
              TextButton(
                onPressed: () {
      ...
      // Todos los campos están llenos, puedes continuar con el guardado o actualización.
      final cliente = Cliente(
        rut: rut,
        nombre: nombre,
        apellido: apellido,
