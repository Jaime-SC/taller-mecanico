    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          drawerItem("Clientes", () => navigateTo(context, ClientesPage(title: 'Clientes'))),
          drawerItem("Vehículos", () => navigateTo(context, VehiculosPage())),
          drawerItem("Orden de Trabajo", () => navigateTo(context, OrdenTrabajoPage())),
...
Container busquedaCliente(TextEditingController searchController, Function(String) filterClientes) => Container(
  width: 500,
...
TextField reusableTextField(String text, IconData icon, bool isPasswordType, TextEditingController controller) => TextField(
...
Container loginButton(BuildContext context, bool isLogin, Function onTap) => Container(
...
Widget textFieldAgregarClientes(String labelText, IconData prefixIcon, bool isPassword, TextEditingController controller) => Container(
